...
---
### プログラミング熱中スコアのチェックリスト

運動が好きな子どもはスポーツを習った方が良いですし、音楽が好きな子どもは音楽教室に行くべきだと考えています。
お子様がプログラミングに熱中できそうかを知るためにチェックリストをご活用ください。
当教室はプログラミングを楽しいと感じる子どもが、より楽しめるように特性に合わせて柔軟に対応します。
