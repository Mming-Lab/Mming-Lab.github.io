...
<img class="img-fluid" src="/assets/img/keyboard_lesson_ja/00_日本語チュートリアル_サムネイル.png" alt="日本語チュートリアル_サムネイル">
...
![ライブラリ](./assets/img/keyboard_lesson_ja/03_ライブラリ.png){: img-responsive img-fluid d-block mx-auto }
...
![ライブラリ](./assets/img/keyboard_lesson_ja/01_英語表示.png){: img-responsive img-fluid d-block mx-auto}

- 作成したワールドの設定からリソースパックを適用してください。
![日本語チュートリアル_サムネイル](./assets/img/keyboard_lesson_ja/04_設定方法.png){: img-responsive img-fluid d-block mx-auto}

- リソースパック適用後にはこのように日本語表示になります。
![ライブラリ](./assets/img/keyboard_lesson_ja/02_日本語表示.png){: img-responsive img-fluid d-block mx-auto}
